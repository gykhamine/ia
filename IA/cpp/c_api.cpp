...
// ============================================================================
// Gestion d'erreurs — evite qu'une exception C++ traverse la frontiere ctypes
// (ce qui provoque un std::terminate() et tue tout le process Python).
// ============================================================================

static thread_local std::string g_last_error;

extern "C" const char* cpp_get_last_error() {
...
#define UNARY_OP(name) \
    extern "C" double* cpp_##name(const double* data, const int64_t* shape, int ndim, \
        ...
        try { \
            ...
            g_last_error = e.what(); *out_ndim = -1; return nullptr; \
        } \
    }
