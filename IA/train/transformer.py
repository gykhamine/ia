...
class _SeedGenerator:
    """Générateur de seeds incrémental pour le moteur C++ (transformer)."""
    __slots__ = ('_state',)
...
class MiniTransformer3D:
    ...
    def backward(self, x, y, out, cache, lr=0.01):
        ...
        d_x_ff_norm = np.tile(d_pooled[:, np.newaxis, :] / seq_len, (1, seq_len, 1))
    ...
    def save(self, filename):
        ...
        header, tensors = serialize_model_dict(model_data)
